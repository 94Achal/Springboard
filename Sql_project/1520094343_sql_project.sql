...
SELECT facid, name, membercost, monthlymaintenance FROM facilities WHERE membercost > 0 AND membercost < (0.8*monthlymaintenance);
...
SELECT * FROM Facilities where facid = 1 || facid = 5;
or
...
SELECT surname, firstname FROM members WHERE memid=(SELECT MAX(memid) FROM members);
